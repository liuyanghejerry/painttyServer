...
var api = new APIConnect();
  ...
  <pre>
<span class="dim">// Create an instance
var api = new APIConnect();</span>
...
// Set the domain
api.domain('search.twitter.com');</span>
...
</span>// With a format<span class="dim">
api.connect('search</span>.json<span class="dim">');</span>
...
// Run the route
api.getSearch(</span>{ q: 'cookpad' }<span class="dim">);</span> // With params
  </pre>
  <pre>
<span class="dim">// Create an instance
var api = new APIConnect();
...
// Run the route
api.getSearch({ q: 'cookpad' }</span>, { success: showResults }); // And a callback
  </pre>
  <pre>
<span class="dim">// Create an instance
var api = new APIConnect();
...
<span class="dim">// And a callback
api.getSearch({ q: 'cookpad' }, { success: showResults });</span>
  </pre>
  <pre>
<span class="dim">// Create an instance
var api = new APIConnect();
...
// Round 2
  ...
  <pre>
<span class="dim">// Round 2</span>

// Create the instance
var api = new APIConnect();
  </pre>
  <pre>
<span class="dim">// Round 2
...
// Connect the route with optional context
api.connect('goals/:goal_id/items.json');</span>
...
api.getManifest(function() {
  ...
  <button>Punch it, Chewie</button>
    ...
    <!--<script src="https://raw.github.com/andrewplummer/APIConnect/master/lib/main.js"></script>-->
